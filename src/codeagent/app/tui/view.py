"""app/tui/view.py:TuiApp——装配协调器、注册 backend 回调并管理顶层生命周期。
...
from codeagent.app.tui.render_coordinator import TuiEventBuffer, TuiRenderCoordinator
from codeagent.app.tui.interaction import (
    TuiInteractionCoordinator,
    _SUGGESTION_WINDOW,
)
from codeagent.app.tui.session_coordinator import TuiSessionCoordinator
from codeagent.app.tui.conversation_coordinator import TuiConversationCoordinator
from codeagent.app.tui.command_coordinator import TuiCommandCoordinator
