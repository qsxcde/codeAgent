...
`test-foundation-stability` 完成后，测试按源码层级组织。经过拆分、契约集中和异步稳定性改造，2026-08-28 当前全量测试为 **948 passed**。`test-foundation-stability` 与 `test-structure-coverage` 均已归档；大型文件的现状和本变更目标如下：
